...
# 补充运行失败的实验
python src/main.py --input_dataset advbench-custom --victim_model_name gpt-4o --judge_model_name gpt-4o --ps wiki-text-infilling-sw --model_name gpt-4o --mode 7 --defense rpo --exp_id 02_09-21_09_52
python src/main.py --input_dataset advbench-custom --victim_model_name gpt-4o --judge_model_name gpt-4o --ps wiki-text-infilling-sp --model_name gpt-4o --mode 7 --defense rpo --exp_id 02_09-21_16_55